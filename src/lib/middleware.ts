...
function addSecurityHeaders(response: NextResponse): NextResponse {
  ...
  response.headers.set(
    ...
    [
      ...
      "img-src 'self' data: blob: https://res.cloudinary.com https://images.unsplash.com https://confettigifts.in https://lh3.googleusercontent.com https://aicagifts.com https://cdn.shopify.com https://*.shopify.com https://img.magnific.com https://encrypted-tbn0.gstatic.com https://images.weserv.nl",
