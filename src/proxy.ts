...
function addSecurityHeaders(response: NextResponse): NextResponse {
  ...
  response.headers.set("Permissions-Policy", "camera=(), microphone=(), geolocation=(), payment=(self \"https://checkout.razorpay.com\" \"https://api.razorpay.com\")");
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      // 'unsafe-eval' is only needed by Next's dev tooling, never in production.
      `script-src 'self' 'unsafe-inline'${process.env.NODE_ENV === "production" ? "" : " 'unsafe-eval'"} https://checkout.razorpay.com https://www.googletagmanager.com https://www.google-analytics.com`,
