...
async function main() {
  ...
  const subDefs = [
    ...
    },
    {
      ...
      slug: "upload-your-photo",
      parentSlug: "style-your-own-gifts",
      description: "Start with your photo and we will create your gift",
    },
    {
      name: "Custom text gifts",
      slug: "custom-text-gifts",
      parentSlug: "style-your-own-gifts",
      description: "Personalise any gift with your own text and message",
    },

    // Mothers day sub-categories
    {
      name: "Customized lamps",
      slug: "customized-lamps",
      parentSlug: "mothers-day-gifts",
      description: "Beautiful LED lamps personalised for mom",
    },
    {
      name: "Flowers and chocolates",
      slug: "flowers-and-chocolates",
      parentSlug: "mothers-day-gifts",
      description: "Flowers and chocolates with a personalised touch",
    },
    {
      name: "Memory scrapbooks",
      slug: "memory-scrapbooks",
      parentSlug: "mothers-day-gifts",
      description: "Handcrafted memory scrapbooks filled with love",
    },
    {
      name: "Personalized cushions",
      slug: "personalized-cushions",
      parentSlug: "mothers-day-gifts",
      description: "Soft photo cushions personalised for mom",
    },

    // Bulk gifting — extra
    {
      name: "Customized branding",
      slug: "customized-branding",
      parentSlug: "bulk-gifting",
      description: "Brand your corporate gifts with your logo",
    },
  ];
