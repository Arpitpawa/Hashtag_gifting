        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-white/60 text-[15px] md:text-[16px] leading-relaxed max-w-lg mb-8">
              Premium personalized gifting for corporates, startups &
              enterprises. From employee onboarding kits to client appreciation
              hampers — we handle everything, end to end.
            </p>
          ...
          <div className="hidden lg:flex flex-col gap-4 items-end">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/10 rounded-2xl p-5 w-72">
              <p className="text-white/50 text-[11px] uppercase tracking-[2px] mb-1">
                Avg. order size
              </p>
              <p
            ...
            <div className="bg-[#c0555a] rounded-2xl p-5 w-72">
              <p className="text-white/70 text-[11px] uppercase tracking-[2px] mb-1">
                Delivered across
              </p>
              <p
                className="text-white text-[28px] font-bold"
