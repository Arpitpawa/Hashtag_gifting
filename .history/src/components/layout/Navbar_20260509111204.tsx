    ...
    <>
      <header className="bg-white relative z-50 shadow-sm">
        ...
        <div className="border-b border-[#ececec]">
          <div className="container-custom h-[52px] flex items-center justify-center gap-4">
          ...
          <div className="container-custom h-[52px] flex items-center justify-center gap-8">
            {navItems.map((item) => (
              ...
              >
                <button
                  style={promptFont}
                  className={`flex items-center gap-1 text-[13px] font-medium tracking-widest uppercase transition-all duration-200 pb-0.5 border-b-2 ${
            ...
            <div className="container-custom py-6">
              {!searchQuery && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div>
                    <h3
                      className="text-[11px] font-semibold text-gray-400 uppercase tracking-[3px] mb-4 flex items-center gap-2"
                      style={promptFont}
                    >
                      <TrendingUp size={14} />
                      Trending Searches
                  ...
                  <div>
                    <h3
                      className="text-[11px] font-semibold text-gray-400 uppercase tracking-[3px] mb-4"
                      style={promptFont}
                    >
                      Popular Products
                    </h3>
                    <div className="flex flex-col gap-3">
                      {allProducts.slice(0, 4).map((product) => (
                        ...
                        >
                          ...
                          <div>
                            <p className="text-[14px] text-gray-700 group-hover:text-black font-medium transition-colors" style={promptFont}>
                              {product.name}
                            </p>
