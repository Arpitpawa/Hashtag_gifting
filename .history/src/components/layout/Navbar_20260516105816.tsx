...
const allProducts = [
  {
    name: "Custom socks",
    image: "https://confettigifts.in/cdn/shop/files/PetFaceSocks.webp?v=1771482164&width=200",
    link: "/product/custom-socks",
    category: "Personalized",
  },
  {
    name: "CineMagic clap",
    image: "https://confettigifts.in/cdn/shop/files/2_b636a062-abbe-48be-80e9-2e47c2b628b5.webp?v=1764568216&width=200",
    link: "/product/cinemagic-clap",
    category: "Personalized",
  },
  {
    name: "Travel memory box",
    image: "https://confettigifts.in/cdn/shop/files/3-9_0615fbf0-3577-466d-8622-5449bdd5d20d.webp?v=1767951776&width=200",
    link: "/product/travel-memory-box",
    category: "Anniversary",
  },
  {
    name: "Wedding caricature",
    image: "https://confettigifts.in/cdn/shop/files/1-16_ad3cd0de-7dad-4136-8f95-cb92ae451fcc.webp?v=1772883529&width=200",
    link: "/product/wedding-caricature",
    category: "Personalized",
  },
  {
    name: "Metal wallet card",
    image: "https://confettigifts.in/cdn/shop/files/2-2_50e1fc1a-0290-4155-bec5-e9ae33018478.webp?v=1761636856&width=200",
  ...
  {
    name: "Flower bouquet",
    image: "https://confettigifts.in/cdn/shop/files/Souvinerbox1.webp?v=1767951776&width=200",
        ...
        <div className="border-b border-[#ececec]">
          <div className="container-custom h-[75px] flex items-center justify-between">
                ...
                <SheetContent side="left" className="w-[300px] bg-[#f7f4ef] p-0">
                  ...
                  <div className="p-5 border-b border-[#e5e5e5]">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-[10px] font-semibold tracking-[3px] text-[#2f3e7a] uppercase mt-1">
                        gifting
                      </span>
                    </div>
                  </div>
                      ...
                      <div key={item.title} className="border-b border-[#ececec]">
                        <button className="w-full text-left px-6 py-4 text-[13px] text-[#333] flex items-center justify-between hover:bg-white transition-colors">
                          <span className="flex items-center gap-2">
                            <item.icon size={14} strokeWidth={1.8} className="text-[#2f3e7a]" />
                            {item.title}
                          </span>
            ...
            <Link href="/" className="flex flex-col items-center leading-none select-none">
              ...
              <span className="text-[9px] font-semibold tracking-[5px] text-[#c0555a] smallcase -mt-1">
                gifting
              </span>
            </Link>
            ...
            <div className="flex items-center gap-2 w-[140px] justify-end">
              ...
              <button className="relative p-2 hover:bg-gray-100 rounded-full transition-colors">
                ...
                <span className="absolute -top-1 -right-1 bg-[#2f3e7a] text-white text-[9px] w-4 h-4 rounded-full flex items-center justify-center font-semibold">
                  0
                </span>
              </button>
            </div>
                  ...
                  <div className="absolute top-full left-1/2 -translate-x-1/2 z-50">
                    ...
                    >
                      ...
                      <div className="bg-[#f7f4ef] px-8 py-3.5 border-b border-[#ececec] flex items-center justify-between">
                        <span className="text-[11px] font-semibold text-[#2f3e7a] tracking-[1px] flex items-center gap-2">
                          <item.icon size={13} strokeWidth={2} className="text-[#2f3e7a]" />
                          {item.featured}
                        </span>
                        <Link
                          href={`/category/${item.title.toLowerCase().replace(/\s+/g, "-")}`}
                          className="text-[11px] text-[#2f3e7a] font-medium flex items-center gap-1 hover:underline"
                        >
                      ...
                      {/* DROPDOWN ITEMS */}
                      <div
                        className={`px-8 py-5 grid gap-x-12 gap-y-0 ${
                      ...
                      >
                        {item.items.map((subItem) => (
                          <Link
                            ...
                            className="text-[13px] font-light text-[#3d3d3d] py-2.5 border-b border-[#f0f0f0] last:border-0 hover:text-[#2f3e7a] transition-colors duration-150"
                          >
                            {subItem}
                          </Link>
                        ))}
