              ...
              <Sheet>
                ...
                >
                  ...
                  <div className="p-6 border-b border-[#e5e5e5]">
                    <span className="text-3xl text-[#111]">
                      Hashtag gifting
                    </span>
                  </div>
        ...
        <div className="hidden lg:block border-b border-[#ececec] bg-white">
          <div className="container-custom h-[50px] flex items-center justify-center gap-6">
            {navItems.map((item) => (
              ...
              >
                <button
                  className={`flex items-center gap-1 text-[11.5px] font-medium tracking-wide capitalize transition-all duration-200 pb-0.5 border-b-2 whitespace-nowrap ${
                  ...
                  <div className="absolute top-full left-1/2 -translate-x-1/2 z-50">
                    ...
                    >
                      ...
                      <div className="bg-[#f7f4ef] px-8 py-4 border-b border-[#ececec] flex items-center justify-between">
                        <span className="text-[11px] font-semibold text-[#2f3e7a] tracking-[2px] flex items-center gap-2">
                          <item.icon
                            size={14}
                            strokeWidth={2}
                            className="text-[#2f3e7a]"
                        ...
                        <Link
                          ...
                          className="text-[11px] text-[#2f3e7a] font-medium flex items-center gap-1 hover:underline tracking-wide"
                        >
                      ...
                      >
                        {item.items.map((subItem) => (
                          <Link
                            ...
                            className="text-[14px] font-light text-[#3d3d3d] py-2.5 border-b border-[#f0f0f0] last:border-0 hover:text-[#2f3e7a] transition-colors duration-150"
                          >
                            {subItem}
                          </Link>
                        ))}
