      ...
      >
        <div className="max-w-[1450px] mx-auto flex flex-col md:flex-row items-center justify-center gap-3 md:gap-12 text-center">
          {[
            ...
            <span
              key={i}
              className="flex items-center gap-2 text-[12px] text-white font-medium"
            >
              {/* ✅ icons now white */}
      ...
      <div className="max-w-[1450px] mx-auto px-4 md:px-6 lg:px-10 pt-14 pb-10">
        ...
        <div className="mt-10 pt-6 border-t border-white/20 flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            {/* Visa */}
            <div
              className="h-7 px-2 bg-white rounded flex items-center justify-center"
              title="Visa"
            >
              <svg
                viewBox="0 0 60 20"
            ...
            {/* Mastercard */}
            <div
              className="h-7 px-1.5 bg-white rounded flex items-center justify-center gap-0.5"
              title="Mastercard"
            >
            ...
            {/* COD */}
            <div
              className="h-7 px-2 bg-white/10 border border-white/20 rounded flex items-center justify-center"
