      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-2 gap-x-16 gap-y-5">
          ...
          {item.items.map((subItem) => (
            ...
            <button
              key={subItem}
              className="group flex items-center justify-between text-left text-[15px] text-[#555] hover:text-[#2f3e7a] transition duration-200"
            >
              ...
              <span className="opacity-0 group-hover:opacity-100 transition text-[#2f3e7a]">
                →
              </span>
