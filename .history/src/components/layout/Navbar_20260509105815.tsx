              ...
              >
                ...
                {activeMenu === item.title && (
                  <div className="absolute top-full left-1/2 -translate-x-1/2 z-50">
                    <div
                      className="bg-white border border-[#ececec] rounded-b-xl shadow-[0_12px_40px_rgba(0,0,0,0.10)] overflow-hidden"
            ...
            <div className="container-custom py-6">
              ...
              {!searchQuery && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  {/* TRENDING */}
                  <div>
                    <h3 className="text-[13px] font-semibold text-gray-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                      <TrendingUp size={14} />
                      Trending Searches
                    </h3>
                      ...
                      {allProducts.slice(0, 4).map((product) => (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-[12px] text-gray-400">{product.category}</p>
                          </div>
                        </Link>
                      ))}
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <div>
                    ...
                    {suggestions.length > 0 ? (
                      ...
                      <p className="text-[14px] text-gray-400">No suggestions found</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {filteredProducts.length > 0 ? (
                      ...
                      <p className="text-[14px] text-gray-400">No products found for "{searchQuery}"</p>
                    )}
                  </div>
                </div>
              )}
