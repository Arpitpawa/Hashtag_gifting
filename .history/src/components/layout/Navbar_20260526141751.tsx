      ...
      <div className="max-w-[1450px] mx-auto px-4 md:px-6 lg:px-10 pt-14 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            {/* LOGO */}
            <Link href="/" className="flex items-center gap-3 leading-none select-none mb-5 w-fit">
              <svg viewBox="0 0 44 32" width="44" height="32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line x1="14" y1="2" x2="11" y2="30" stroke="white" strokeWidth="3.5" strokeLinecap="round"/>
                <line x1="25" y1="2" x2="22" y2="30" stroke="white" strokeWidth="3.5" strokeLinecap="round"/>
                <line x1="6"  y1="11" x2="34" y2="11" stroke="white" strokeWidth="3.5" strokeLinecap="round"/>
                <line x1="5"  y1="21" x2="33" y2="21" stroke="white" strokeWidth="3.5" strokeLinecap="round"/>
              </svg>
              <div className="flex flex-col">
                <div className="flex items-baseline gap-1.5">
                  <span className="text-[22px] font-bold tracking-tight text-white">tag</span>
                  <span className="text-[10px] font-semibold tracking-[3px] text-[#f4b8b8] uppercase">gifting</span>
                </div>
                <span className="text-[8px] tracking-[1.5px] text-white/50 uppercase">Change the idea of gifting</span>
              </div>
            </Link>
        ...
        <div className="mt-10 pt-6 border-t border-white/20 flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {/* Mastercard */}
            <div className="h-7 px-1.5 bg-white rounded flex items-center justify-center gap-0.5" title="Mastercard">
              <div className="w-5 h-5 rounded-full bg-[#EB001B] opacity-90" />
              <div className="w-5 h-5 rounded-full bg-[#F79E1B] opacity-90 -ml-2.5" />
            </div>
            {/* UPI */}
            <div className="h-7 px-2 bg-white rounded flex items-center justify-center" title="UPI">
              <svg viewBox="0 0 50 22" height="14" xmlns="http://www.w3.org/2000/svg">
                <text x="0" y="16" fontFamily="Arial" fontWeight="900" fontSize="16" fill="#097939">UPI</text>
              </svg>
            </div>
            {/* Razorpay */}
            <div className="h-7 px-2 bg-white rounded flex items-center justify-center" title="Razorpay">
              <svg viewBox="0 0 100 30" height="14" xmlns="http://www.w3.org/2000/svg">
                <polygon points="10,0 20,18 0,18" fill="#2D81F7" />
                <text x="24" y="18" fontFamily="Arial" fontWeight="bold" fontSize="14" fill="#072654">razorpay</text>
              </svg>
            </div>
            {/* COD */}
