      ...
      >
        <div className="max-w-[1450px] mx-auto flex flex-col md:flex-row items-center justify-center gap-3 md:gap-12 text-center">
          {[
            {
              icon: <Zap size={13} />,
              text: "3-hour express delivery in Jaipur",
            },
            {
              icon: <Gift size={13} />,
            ...
            {
              icon: <Heart size={13} />,
              text: "100% customized & made with love",
            },
            {
            ...
            <span
              key={i}
              className="flex items-center gap-2 text-[12px] text-white/70 font-medium"
            >
      ...
      <div className="max-w-[1450px] mx-auto px-4 md:px-6 lg:px-10 pt-14 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <Link
              href="/"
              className="flex flex-col leading-none select-none mb-5 w-fit"
            >
