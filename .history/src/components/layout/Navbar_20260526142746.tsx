        ...
        <div className="border-b border-[#ececec]">
          <div className="container-custom h-[75px] flex items-center justify-between">
                  ...
                  <div className="p-5 border-b border-[#e5e5e5]">
                    <div className="flex flex-col leading-none">
                      <span style={{ fontFamily: "var(--font-playfair), serif" }}
                        className="text-[20px] font-semibold tracking-wide text-[#1a1a1a]">
                        Hashtag
                      </span>
                      <span className="text-[7px] font-medium tracking-[5px] text-[#c0555a] uppercase mt-0.5">gifting</span>
                    </div>
                  </div>
                  {/* Mobile switcher */}
            ...
            <Link href="/" className="flex flex-col items-center leading-none select-none absolute left-1/2 -translate-x-1/2">
              <span style={{ fontFamily: "var(--font-playfair), serif" }}
                className="text-[26px] md:text-[30px] font-semibold tracking-wide text-[#1a1a1a] leading-none">
                Hashtag
              </span>
              <span className="text-[8px] font-medium tracking-[6px] text-[#c0555a] uppercase mt-1">
                gifting
              </span>
            </Link>
