              ...
              <Sheet>
                ...
                <SheetContent side="left" className="w-[300px] bg-[#f7f4ef] p-0">
                  ...
                  <div className="flex gap-2 px-5 py-3 border-b border-[#ececec]">
                    <Link href="/" className={`flex-1 text-center py-2 rounded-full text-[12px] font-semibold border transition-all ${!isCorporate ? "bg-[#c0555a] text-white border-[#c0555a]" : "bg-white text-[#555] border-[#e0dbd4]"}`}>
                      Personal
                    </Link>
                    <Link href="/corporate" className={`flex-1 text-center py-2 rounded-full text-[12px] font-semibold border transition-all ${isCorporate ? "bg-[#2f3e7a] text-white border-[#2f3e7a]" : "bg-white text-[#555] border-[#e0dbd4]"}`}>
                      Corporate
                    </Link>
                  </div>
                      ...
                      <div key={item.title} className="border-b border-[#ececec]">
                        <button className="w-full text-left px-6 py-4 text-[13px] text-[#333] flex items-center justify-between hover:bg-white transition-colors">
                          <span className="flex items-center gap-2">
                            <item.icon size={14} strokeWidth={1.8} className={isCorporate ? "text-[#2f3e7a]" : "text-[#c0555a]"} />
                            {item.title}
                          </span>
                  ...
                  <div className="absolute top-full left-1/2 -translate-x-1/2 z-50">
                    ...
                    >
                      <div className="bg-[#f7f4ef] px-8 py-3.5 border-b border-[#ececec] flex items-center justify-between">
                        <span className={`text-[11px] font-semibold tracking-[1px] flex items-center gap-2 ${isCorporate ? "text-[#2f3e7a]" : "text-[#c0555a]"}`}>
                          <item.icon size={13} strokeWidth={2} className={isCorporate ? "text-[#2f3e7a]" : "text-[#c0555a]"} />
                          {item.featured}
                        </span>
                        <Link
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {trendingSearches.map((term) => (
                        <button key={term} onClick={() => setSearchQuery(term)} className="px-4 py-1.5 rounded-full border border-gray-200 text-[12px] text-gray-600 hover:border-black hover:text-black transition-all duration-200">
                          {term}
                        </button>
                      ))}
                    </div>
