      ...
      <header className="bg-white relative z-50">
        ...
        <div className="border-b border-[#ececec]">
          <div className="container-custom h-[75px] flex items-center justify-between">
                ...
                <SheetContent side="left" className="w-[300px] bg-[#f7f4ef] p-0">
                  ...
                  <div className="p-5 border-b border-[#e5e5e5]">
                    <div className="flex items-center gap-2">
                      <svg viewBox="0 0 40 28" width="32" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line x1="13" y1="2" x2="10" y2="26" stroke="#1a1a1a" strokeWidth="3.5" strokeLinecap="round"/>
                        <line x1="23" y1="2" x2="20" y2="26" stroke="#1a1a1a" strokeWidth="3.5" strokeLinecap="round"/>
                        <line x1="6"  y1="10" x2="32" y2="10" stroke="#1a1a1a" strokeWidth="3.5" strokeLinecap="round"/>
                        <line x1="5"  y1="19" x2="31" y2="19" stroke="#1a1a1a" strokeWidth="3.5" strokeLinecap="round"/>
                      </svg>
                      <div className="flex flex-col">
                        <div className="flex items-baseline gap-1">
                          <span className="text-[16px] font-bold tracking-tight text-[#1a1a1a]">tag</span>
                          <span className="text-[9px] font-semibold tracking-[2px] text-[#c0555a] uppercase">gifting</span>
                        </div>
                        <span className="text-[7px] tracking-[1px] text-[#aaa] uppercase">Change the idea of gifting</span>
                      </div>
                    </div>
                  </div>
                  {/* Mobile switcher */}
            ...
            {/* ── CENTER — LOGO ── */}
            <Link href="/" className="flex flex-col items-center leading-none select-none absolute left-1/2 -translate-x-1/2 group">
              {/* Hashtag symbol */}
              <svg viewBox="0 0 52 36" width="52" height="36" className="mb-0.5" fill="none" xmlns="http://www.w3.org/2000/svg">
                {/* Vertical lines */}
                <line x1="17" y1="2"  x2="13" y2="34" stroke="#1a1a1a" strokeWidth="4" strokeLinecap="round"/>
                <line x1="30" y1="2"  x2="26" y2="34" stroke="#1a1a1a" strokeWidth="4" strokeLinecap="round"/>
                {/* Horizontal lines */}
                <line x1="8"  y1="13" x2="42" y2="13" stroke="#1a1a1a" strokeWidth="4" strokeLinecap="round"/>
                <line x1="6"  y1="24" x2="40" y2="24" stroke="#1a1a1a" strokeWidth="4" strokeLinecap="round"/>
              </svg>
              {/* tag text */}
              <div className="flex items-baseline gap-[1px]">
                <span className="text-[18px] md:text-[20px] font-bold tracking-tight text-[#1a1a1a]">tag</span>
                <span className="text-[10px] font-semibold tracking-[3px] text-[#c0555a] uppercase ml-1">gifting</span>
              </div>
              {/* tagline */}
              <span className="text-[8px] tracking-[1.5px] text-[#aaa] uppercase mt-0.5 whitespace-nowrap">
