          ...
          <div className="container-custom h-[75px] flex items-center justify-between">
                  ...
                  <div className="p-5 border-b border-[#e5e5e5]">
                    <div className="flex flex-col leading-none">
                      <div className="flex items-baseline">
                        <span className="text-[22px] font-black text-[#c0555a]">#</span>
                        <span className="text-[20px] font-black text-[#1a1a1a] tracking-tight">tag</span>
                      </div>
                      <span className="text-[7px] font-semibold tracking-[3px] text-[#888] uppercase">gifting</span>
                    </div>
                  </div>
                  {/* Mobile switcher */}
            ...
            <Link href="/" className="flex flex-col items-center leading-none select-none absolute left-1/2 -translate-x-1/2">
              <div className="flex items-baseline gap-0">
                <span className="text-[28px] md:text-[32px] font-black text-[#c0555a] leading-none">#</span>
                <span className="text-[24px] md:text-[28px] font-black text-[#1a1a1a] tracking-tight leading-none">tag</span>
              </div>
              <span className="text-[7.5px] font-semibold tracking-[4px] text-[#888] uppercase mt-0.5 whitespace-nowrap">
                gifting
              </span>
            </Link>
