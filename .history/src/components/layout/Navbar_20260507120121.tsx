            ...
            >
              ...
              {activeMenu === item.title && (
                ...
                <div className="absolute top-full left-1/2 -translate-x-1/2 pt-3 z-50">
                  ...
                  <div className="bg-white min-w-[520px] border border-[#e7e2d9] shadow-lg rounded-[10px] p-8">
                    ...
                    <div className="grid grid-cols-2 gap-x-14 gap-y-5">
                      ...
                      {item.items.map((subItem) => (
                        ...
                        <button
                          key={subItem}
                          className="text-left text-[15px] text-[#555] hover:text-[#2f3e7a] transition whitespace-nowrap"
                        >
                          {subItem}
                        </button>
