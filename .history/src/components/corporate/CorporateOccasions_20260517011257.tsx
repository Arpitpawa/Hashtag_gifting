  ...
  return (
    <section className="py-12 w-full">
      <div className="container-custom">
        ...
        {/* Background Wrapper */}
        <div className="relative overflow-hidden rounded-[32px] h-[560px] flex items-center">

          {/* Background Image */}
          <img
            src="https://images.unsplash.com/photo-1512909006721-3d6018887383?q=80&w=100&auto=format&fit=crop"
            alt="Corporate Gifts"
