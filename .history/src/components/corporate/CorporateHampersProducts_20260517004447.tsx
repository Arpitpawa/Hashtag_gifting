        ...
        {!showAll && (
          <div className="text-center mt-12">
            <button
              ...
              className="inline-flex items-center gap-2 px-10 py-4 bg-white text-[#c0555a] text-[13px] font-semibold rounded-full hover:bg-[#c0555a] text transition-all duration-300"
            >
              Load More
