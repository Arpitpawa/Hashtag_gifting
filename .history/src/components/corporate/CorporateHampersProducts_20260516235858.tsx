      ...
      <div className="max-w-[1450px] mx-auto px-4 md:px-6 lg:px-10">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p
            ...
            style={promptFont}
          >
            Choose from a wide range of 500+ corporate gifting options — fully
            customized with your brand, logo & message.
          </p>
          ...
          {visibleProducts.map((product, i) => (
            <Link key={i} href={product.link} className="group block">
              ...
              <div className="relative overflow-hidden rounded-xl bg-[#f5f0ea] aspect-square mb-4">
                ...
                {/* QUICK VIEW on hover */}
                <div
                  className="absolute bottom-0 left-0 right-0 bg-black/80 text-white text-[12px] font-medium py-2.5 text-center translate-y-full group-hover:translate-y-0 transition-transform duration-300"
                  style={promptFont}
                >
                  Quick View
                </div>
