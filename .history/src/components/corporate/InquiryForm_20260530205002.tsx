    ...
    <section id="inquiry" className="pt-0 pb-16 md:pb-20">
      <div className="max-w-[1450px] mx-auto px-4 md:px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div>
            <h2
              className="text-[42px] md:text-[66px] font-normal text-[#1a1a1a] mb-8 leading-tight"
            ...
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <p className="text-[#6b6b6b] text-[14px] mb-6">
                  WhatsApp has opened with your details. Our team will respond within 2 hours.
                </p>
                <button
                  onClick={() => {
                    setSubmitted(false);
                    setForm({ name: "", phone: "", company: "", email: "", budget: "", quantity: "", message: "" });
                  }}
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <p className="text-[11px] text-[#aaa] text-center">
                  Clicking submit will open WhatsApp with your details pre-filled. We'll respond within 2 hours (9am – 8pm).
                </p>
              </form>
            )}
          </div>
