...
const testimonials = [
  ...
  },
  {
    ...
    time: "2 months ago",
    review:
      "Bought my first customization product — it is marvelous with so much shimmer in design in every detail. We gifted it to my daughter, it is magical and adorned with the best quality which was extremely exceptional!",
    avatar: "V",
    color: "#c4922a",
    tag: "Custom Design",
  },
  {
    ...
    time: "1 month ago",
    review:
      "Amazing experience with plenty of gift options. Very patient and helpful staff who helped me choose the perfect gift for my loved ones!",
    avatar: "N",
    color: "#e07b7b",
    tag: "Gift Options",
  },
  {
    ...
    time: "2 months ago",
    review:
      "It is a great shop to buy gifts from. They perform so many customization facilities at a very reasonable price. I loved it — highly recommend others to try them too!",
    avatar: "S",
    color: "#a8c5a0",
    tag: "Value for Money",
  },
  ...
  },
  {
    ...
    time: "2 months ago",
    review:
      "Got some gifts by order which was fulfilled in 2 days. Satisfied experience was observed and can be recommended to others for the same. Excellent service!",
    avatar: "D",
    color: "#b8a9d4",
    tag: "Fast Delivery",
  },
    ...
    <section className="py-16 md:py-24 bg-[#f7f4ef]">
      <div className="max-w-[1450px] mx-auto px-4 md:px-6 lg:px-10">
        ...
        <div className="mb-12 md:mb-16">
          <p className="text-[#c4922a] text-base uppercase tracking-[3px] font-medium mb-3">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <div className="flex items-center gap-4 bg-white rounded-2xl px-6 py-4 shadow-sm border border-[#e8e0d5] w-fit">
              <div>
                ...
                <p className="text-[13px] text-[#888]">Google Rating</p>
              </div>
            ...
            {testimonials.map((t, index) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col gap-4 flex-1">
                  ...
                  {/* REVIEW */}
                  <p className="text-[14px] text-[#3d3d3d] leading-relaxed flex-1">
                    "{t.review}"
                  </p>
