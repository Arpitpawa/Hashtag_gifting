    ...
    <section className="pt-0 pb-0 relative overflow-hidden">
      ...
      <div className="bg-[#c0392b] pt-14 md:pt-16 pb-16 md:pb-20 px-4 md:px-6 lg:px-10">
        ...
        <div className="text-center mb-10 md:mb-12">
          <p
            className="text-white/60 text-[11px] font-semibold uppercase tracking-[4px] mb-3"
            style={promptFont}
          >
            something for everyone
          </p>
          <h2
            className="text-white text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-[3px]"
            style={promptFont}
          >
            Shop by Category
          </h2>
            ...
            {categories.map((cat, index) => (
              ...
              >
                ...
                <div className="px-3 py-3">
                  <h3
                    className="text-[13px] md:text-[14px] font-semibold text-[#1a1a1a] group-hover:text-[#c0392b] transition-colors duration-200 leading-snug"
                    style={promptFont}
                  >
                    {cat.name}
                  </h3>
