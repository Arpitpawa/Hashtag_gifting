...
const brands = [
  { name: "TATA", logo: "YOUR_TATA_LOGO_URL" },
  { name: "Mahindra", logo: "YOUR_MAHINDRA_LOGO_URL" },
  { name: "HDFC Bank", logo: "YOUR_HDFC_LOGO_URL" },
  { name: "Infosys", logo: "YOUR_INFOSYS_LOGO_URL" },
  { name: "Wipro", logo: "YOUR_WIPRO_LOGO_URL" },
  { name: "ICICI Bank", logo: "YOUR_ICICI_LOGO_URL" },
  { name: "Reliance", logo: "YOUR_RELIANCE_LOGO_URL" },
  { name: "Apollo", logo: "YOUR_APOLLO_LOGO_URL" },
  { name: "Bajaj", logo: "YOUR_BAJAJ_LOGO_URL" },
  { name: "HCL", logo: "YOUR_HCL_LOGO_URL" },
  { name: "Fortis", logo: "YOUR_FORTIS_LOGO_URL" },
  { name: "Tech Mahindra", logo: "YOUR_TECH_MAHINDRA_LOGO_URL" },
];
