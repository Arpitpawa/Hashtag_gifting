...
const posts = [
  {
    ...
    price: "Rs. 899", oldPrice: "Rs. 1,299",
  ...
  },
  {
    ...
    price: "Rs. 1,499", oldPrice: "Rs. 1,999",
  ...
  },
  {
    ...
    price: "Rs. 799", oldPrice: "Rs. 1,199",
  ...
  },
  {
    ...
    price: "Rs. 2,499", oldPrice: "Rs. 3,499",
            ...
            {posts.map((post, i) => (
              <div key={i} className="flex-shrink-0 w-[220px] md:w-[250px] flex flex-col group">
                ...
                <a href={post.instaLink} target="_blank" rel="noopener noreferrer"
                  ...
                  <Image src={post.thumbnail} alt={post.product} fill
                  ...
                  <div className="absolute top-3 right-3">
                    <span className="text-[10px] font-bold text-white bg-[#c0555a] px-2 py-0.5 rounded-full">{post.tag}</span>
                  </div>
                ...
                <div className="mt-3 flex flex-col gap-2">
                  <p className="text-[13px] font-semibold text-[#1a1a1a] leading-snug line-clamp-1">{post.product}</p>
            ...
            <div className="flex-shrink-0 w-[220px] md:w-[250px]">
              <a href={INSTA} target="_blank" rel="noopener noreferrer"
                ...
                <div className="text-center">
                  ...
                  <p className="text-[12px] text-[#888] mt-2 leading-relaxed">100+ happy customers share their unboxing every day</p>
                </div>
