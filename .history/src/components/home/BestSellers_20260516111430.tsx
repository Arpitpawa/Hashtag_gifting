...
<div className="flex items-center justify-center gap-6 mt-14">
  <button
    ...
    className="px-8 py-4 border border-[#c0555a] text-[#c0555a] font-medium tracking-wide hover:bg-[#c0555a] hover:text-white transition-all duration-300"
  >
    View All Products
  </button>
  ...
  <button
    ...
    className="w-14 h-14 rounded-full border border-[#c0555a] flex items-center justify-center text-[#c0555a] hover:bg-[#c0555a] hover:text-white transition-all duration-300"
  >
