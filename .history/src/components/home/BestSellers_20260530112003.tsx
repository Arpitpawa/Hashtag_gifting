                ...
                >
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    >
                      <Heart
                        size={16}
                        className={isWishlisted(product.id) ? "fill-[#c0555a] text-[#c0555a]" : ""}
                      />
                    </button>
                  ...
                  {/* INFO */}
                  <div className="p-5">
                    <h3 className="text-[15px] font-semibold text-gray-900 mb-2 capitalize">
                      {product.name}
                    </h3>
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {product.comparePrice && (
                        <>
                          ...
                          <span className="text-[#c0555a] text-[12px] font-medium">
                            {savePercent(product.price, product.comparePrice)}
                          </span>
                        </>
                      )}
                    </div>
