              ...
              <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl p-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[13px] font-semibold text-[#1a1a1a] line-clamp-1">{currentReel.product}</p>
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2">
            {reels.map((_, i) => (
              <button
                ...
                className={`rounded-full transition-all duration-300 ${i === activeModal ? "w-6 h-2 bg-white" : "w-2 h-2 bg-white/40"}`}
              />
            ))}
          </div>
        </div>
