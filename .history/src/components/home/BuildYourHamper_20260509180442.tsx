    ...
    <section className="pt-0 pb-0 relative overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px] md:min-h-[700px]">
        ...
        >
          {/* EYEBROW */}
          <p
            className="text-white/60 text-[11px] font-semibold uppercase tracking-[4px] mb-6"
            style={promptFont}
          >
          ...
          {/* DESCRIPTION */}
          <p
            className="text-white/60 text-[14px] md:text-[15px] leading-relaxed max-w-md mb-10"
            style={promptFont}
          >
          ...
          <div className="flex flex-col gap-6 mb-12">
            {steps.map((step) => (
              <div key={step.number} className="flex items-start gap-5">
                <span
                  className="text-white/40 text-[13px] font-bold tracking-widest flex-shrink-0 mt-0.5"
                  style={promptFont}
                >
                  {step.number}
                </span>
                <div>
                  ...
                  <p
                    className="text-white/50 text-[13px] md:text-[14px]"
                    style={promptFont}
                  >
                    {step.desc}
                  </p>
