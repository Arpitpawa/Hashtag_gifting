    ...
    <section className="pt-0 pb-0 relative overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px] md:min-h-[700px]">
        ...
        >
          ...
          <Link
            href="/build-hamper"
            className="inline-flex items-center justify-center gap-3 bg-white text-[13px] font-semibold tracking-wider px-10 py-5 hover:bg-white/90 transition-all duration-300 w-full md:w-auto rounded-sm"
