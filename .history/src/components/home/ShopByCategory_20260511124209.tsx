      ...
      >
        ...
        <div className="max-w-[1450px] mx-auto">
          ...
          <div className="text-center mt-10">
            <Link
              href="/categories"
              className="inline-flex items-center gap-3 px-8 py-4 bg-white font-semibold text-[13px] tracking-wider hover:bg-white/90 transition-all duration-300 rounded-full small"
