...
const slides = [
  {
    id: 1,
    image:
      "https://aicagifts.com/cdn/shop/files/Generative_Fill_3_06168f08-294e-41d7-9a34-acd09592c0c6.jpg?crop=center&height=800&v=1753897752&width=1600&fit=crop",
  ...
  },
  {
    id: 2,
    image:
      "https://aicagifts.com/cdn/shop/files/Generative_Fill_65f2a7d3-c62c-48eb-a8c3-ed057dbd6bb0.jpg?crop=center&height=800&v=1753897752&width=1600&fit=crop",
              ...
              <div className="relative z-20 h-full flex items-center">
                <div className="max-w-7xl mx-auto px-6 md:px-12 w-full">
                  <div className="max-w-2xl text-white">
                    ...
                    {/* Button */}
                    <button className="mt-8 bg-white text-[#c0555a] px-8 py-4 text-sm tracking-[2px] font-semibold hover:bg-[#f4d35e] hover:text-black transition-all duration-300">
                      {slide.button}
                    </button>
                  </div>
                </div>
