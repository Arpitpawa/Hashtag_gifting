...
export default function TrendingGifts() {
  ...
  <button
    ...
    className="px-8 py-4 rounded-full border border-g-300 text-[#c0555a] font-medium whitespace-nowrap hover:bg-[#c0555a] hover:text-white hover:border-[#c0555a] transition-all duration-300 flex items-center gap-3"
  >
