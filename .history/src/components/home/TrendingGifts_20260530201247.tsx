...
const products = [
  {
    ...
    price: "Rs. 799", old: "Rs. 999", save: "Save 20%", badge: "Best seller",
  ...
  },
  {
    ...
    price: "Rs. 1290", old: "Rs. 1490", save: "Save 13%", badge: "",
  ...
  },
  {
    ...
    price: "Rs. 399", old: "Rs. 499", save: "Save 20%", badge: "",
  ...
  {
    name: "LED name frame",
    price: "Rs. 999", old: "Rs. 1299", save: "Save 23%", badge: "Best seller",
  ...
  },
  {
    ...
    price: "Rs. 699", old: "Rs. 799", save: "Save 13%", badge: "Best seller",
  ...
  },
  {
    ...
    price: "Rs. 490", old: "Rs. 590", save: "Save 17%", badge: "",
    image1: "https://confettigifts.in/cdn/shop/files/1-16_ad3cd0de-7dad-4136-8f95-cb92ae451fcc.webp?v=1772883529&width=800",
    image2: "https://confettigifts.in/cdn/shop/files/4-7_6d3afacb-f70e-495e-896b-b260f34b2dc1.webp?v=1772883529&width=800",
  ...
  },
  {
    ...
    price: "Rs. 990", old: "Rs. 1090", save: "Save 10%", badge: "Best seller",
    image1: "https://confettigifts.in/cdn/shop/files/2-2_50e1fc1a-0290-4155-bec5-e9ae33018478.webp?v=1761636856&width=800",
    image2: "https://confettigifts.in/cdn/shop/files/CopyofIMG_2509.jpg?v=1761636856&width=800",
              ...
              <div key={index} className="min-w-[260px] md:min-w-[300px] flex-shrink-0 group">
                <div className="relative rounded-2xl overflow-hidden bg-white">
                  <div className="relative h-[280px] md:h-[320px]">
                    <Image src={product.image1} alt={product.name} fill
                      className="object-cover transition-opacity duration-500 group-hover:opacity-0"
                      sizes="(max-width: 768px) 260px, 300px" />
                    <Image src={product.image2} alt={product.name} fill
                  ...
                  <button onClick={() => toggleWishlist(index)}
