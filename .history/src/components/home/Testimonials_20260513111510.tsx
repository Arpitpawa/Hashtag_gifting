    ...
    <section className="py-16 md:py-20 relative overflow-hidden">
      <div className="max-w-[1450px] mx-auto px-4 md:px-6 lg:px-10">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <p className="text-[#c4922a] text-sm smallcase tracking-[3px] font-medium">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map((t, index) => (
            <div key={index} className="flex flex-col">
              ...
              {/* NAME + TAG */}
              <div className="mb-3">
                <p className="text-[13px] font-bold text-[#1a1a1a] smallcase tracking-wide">
                  {t.name}
                </p>
                {/* SINGLE COLOR for all tags — navy blue */}
                <p className="text-[12px] font-semibold uppercase tracking-wide mt-0.5 text-[#2f3e7a]">
                  {t.tag}
                </p>
              </div>
              ...
              <div className="flex items-center gap-0.5 mb-3">
                {[...Array(t.rating)].map((_, i) => (
                  <Star key={i} size={13} className="fill-[#f4b56a] text-[#f4b56a]" />
                ))}
              </div>
              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t border-[#f0ece6]">
                ...
                <div className="flex items-center gap-1 bg-[#f7f4ef] px-2 py-1 rounded-full">
                  <GoogleIcon size={12} />
                  <span className="text-[10px] text-[#555] font-medium">Google</span>
                </div>
              </div>
            </div>
          ))}
