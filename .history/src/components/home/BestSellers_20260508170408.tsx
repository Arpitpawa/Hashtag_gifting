...
export default function BestSellers() {
  ...
  return (
    <section className="mt-20 md:mt-32 py-24 md:py-28 bg-[var(--bg-section)]">
      <div className="max-w-[1450px] mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div
            ref={sliderRef}
            className="flex gap-7 overflow-x-auto scroll-smooth no-scrollbar pb-2"
          >
            {products.map((product, index) => (
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  <button className="absolute top-4 right-4 bg-white/90 backdrop-blur-md p-2.5 rounded-full shadow-md hover:bg-black hover:text-white transition-all duration-300">
                    <Heart size={17} />
                  </button>
