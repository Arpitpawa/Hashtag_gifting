...
export default function Testimonials() {
  ...
  return (
    <section className="py-24 bg-[#f7f4ef] overflow-hidden">
      ...
      <div className="max-w-[160px] mx-auto px-4 md:px-8">

        {/* HEADING */}
        <div className="text-center mb-16">

          <span
            className="text-[#c69a63] text-2xl italic"
            style={caveatFont}
          >
          ...
          <p
            className="text-[#5d6677] text-lg mt-5"
            style={promptFont}
          >
          ...
          <div className="flex items-center justify-center gap-2 mt-5">
            ...
            <span
              className="font-semibold text-[#1f2b46]"
              style={promptFont}
            >
              4.9/5
            </span>
    ...
    >
      ...
      >
        ...
        <div className="p-7 md:p-8">
          ...
          {/* REVIEW */}
          <p
            className="text-[18px] leading-[1.8] text-[#24324a]"
            style={promptFont}
          >
            “{item.review}”
          </p>
          ...
          <div className="mt-8">
            ...
            <p
              className="text-[#5d6677] mt-3 text-sm tracking-wide uppercase"
              style={promptFont}
            >
