...
<div className="min-w-[220px] flex items-center justify-center">
  ...
  >
    <div className="px-8 py-4 border border-[#c0555a] text-[#c0555a] font-medium whitespace-nowrap group-hover:bg-[#c0555a] group-hover:text-white transition-all duration-300">
      View All Products
    </div>

    <div className="w-14 h-14 rounded-full border border-[#c0555a] flex items-center justify-center text-[#c0555a] group-hover:bg-[#c0555a] group-hover:text-white transition-all duration-300">
