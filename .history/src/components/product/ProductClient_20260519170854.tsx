    ...
    <div className="min-h-screen bg-[#f3efe8]">
      ...
      <div className="max-w-[1450px] mx-auto px-4 md:px-6 lg:px-10 py-8">
        ...
        "
              ...
              ${
                activeImg === i
                  ? "border-[#c0555a] shadow-[0_8px_25px_rgba(192,85,90,0.25)]"
                  : "border-[#e8e0d5] hover:border-[#c0555a]/40"
              }
            `}
                    >
                      <Image
        ...
        "
            ...
            duration-500
            ease-out
            ${zoomed ? "scale-[1.45]" : "scale-100 group-hover:scale-105"}
          `}
                    style={
                      zoomed
                        ? {
                  ...
                  <div className="absolute top-4 left-4 flex flex-col gap-2 z-20">
                    ...
                    {discount > 0 && (
                      <span className="bg-[#c4922a] text-white text-[11px] font-bold px-3 py-1.5 rounded-full shadow-lg">
                        {discount}% OFF
                      </span>
                    )}

                    {product.customizable && (
                      <span className="bg-black/70 backdrop-blur-md text-white text-[11px] font-semibold px-3 py-1.5 rounded-full">
                        ✨ Personalized
                      </span>
                    )}
                  </div>
          ...
          "
                  >
                    <Expand size={16} className="text-[#555]" />
                  </button>
      ...
      "
              ...
              {/* PHOTO COUNT */}
              {total > 1 && (
                <span className="ml-auto text-[12px] text-[#999] font-medium">
