        ...
        <div className="flex-1 overflow-y-auto grid grid-cols-1 md:grid-cols-2 min-h-0">
          ...
          <div className="p-5 bg-[#f8f5f0] border-b md:border-b-0 md:border-r border-[#ede8e0] flex flex-col">
            ...
            <div ref={containerRef}
              ...
              style={{ cursor: customerPhoto ? "grab" : "default" }}
                ...
                <div
                  ...
                  <img
                    ...
                    style={{
                      ...
                      top: "50%",
                      left: "50%",
                      transform: `translate(calc(-50% + ${photoOffset.x}px), calc(-50% + ${photoOffset.y}px)) scale(${photoScale}) rotate(${photoRotation}deg)`,
                      width: "100%",
                      height: "100%",
                      objectFit: "cover",
                      cursor: "grab",
