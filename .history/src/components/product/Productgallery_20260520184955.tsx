    ...
    <div className="lg:sticky lg:top-6 lg:self-start">
      <div className="flex gap-3">
        ...
        <div
          ...
          style={{ scrollbarWidth: "none", maxHeight: "clamp(280px, 38vw, 480px)" }}
        >
          {images.map((img, i) => (
            <button
              key={i}
              ...
              className={`
                ...
                ${activeImg === i
                  ...
                  : "border-transparent opacity-70 hover:opacity-100 hover:border-[#e8e0d5]"
                }
              `}
            >
              <Image
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between mt-3">
            <button
              onClick={onShare}
              className="flex items-center gap-1.5 text-[13px] text-[#888] hover:text-[#c0555a] transition-colors"
            >
              <Share2 size={14} />
              Share
            </button>
