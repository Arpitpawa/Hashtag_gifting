...
export default function ProductClient({ product }: { product: Product }) {
  ...
  useEffect(() => {
    try {
      ...
      if (saved) {
        const { customization: c } = JSON.parse(saved);
        setCustomization(c);
      }
    } catch {}
  }, [product.id]);
    ...
    <div className="min-h-screen bg-[#f3efe8]">
      ...
      {showPurchased && (
        <div className="fixed bottom-24 left-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl p-4 flex items-center gap-3 border border-[#e8e0d5] max-w-[280px]">
            <div className="relative w-12 h-12 rounded-xl overflow-hidden flex-shrink-0 bg-[#f3efe8]">
              <Image
      ...
      <div className="max-w-[1450px] mx-auto px-4 md:px-6 lg:px-10 py-8">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {!isOutOfStock && (
                <span className="text-[12px] text-[#6b6b6b] flex items-center gap-1">
                  ...
                  Order in{" "}
                  <span className="font-bold text-[#c0555a] mx-1">
                ...
                {[
                  {
                    ...
                    sub: "Beautiful box + ribbon + free message card",
                    price: "+Rs. 99",
                  },
                  {
        ...
        <div className="bg-white rounded-2xl border border-[#e8e0d5] shadow-sm mb-16 overflow-hidden">
          <div className="flex border-b border-[#e8e0d5] overflow-x-auto no-scrollbar">
